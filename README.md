...
C выполненным заданием второго этапа можете ознакомится по этой [ссылке.](https://github.com/pocketgodru/SiriusAI_detection_tropical_cyclone/tree/main/second_stage)

## Содержание:

- [🌪 Введение](#🌪-введение)

- [✏️ Изменения](#✏️изменения)
...
- [⚖️ Преимущества и возможные риски](#⚖️-преимущества-и-возможные-риски) 

- [⌨️ Реализация](#⌨️-реализация)
...
# ⚖️ Преимущества и возможные риски

![image](https://github.com/pocketgodru/SiriusAI_detection_tropical_cyclone/assets/104260621/c7021a99-f193-442b-bbb5-d23b9f6a76f7)
...
1.	Использование последних версий моделей, таких как R-CNN, YOLO или SSD, повысит точность распознавания тропических циклонов.
  ...
  2.	Улучшение и расширение датасета:
   ...
   - Использование вручную размещенного датасета
...
1.	Автоматическое и **точное** обнаружение тропических циклонов с расчётом его центра и направления 
движения

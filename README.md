...
Основная идея и концепция предлагаемого нами решения  -   обучить нейронную сеть для детекции тропических циклонов модель, обученную на открытых, либо созданных нами датасетах.

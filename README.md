...
Для более удобного тестирования обученной модели предлагаем вам протестировать её в Телеграмме используя бота найти которого вы можете по [по этой ссылке](https://t.me/cyclone_detection_bot) или воспользоваться Qr-кодом:

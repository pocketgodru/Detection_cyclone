...
Мы провели тестовое обучение модели `YOLOv8` на [наборе данных](https://universe.roboflow.com/hanwen-zhang-poufi/typhoon-6pqhj/dataset/2), который включает в себя обнаружение тропического циклона и их центра.

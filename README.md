...
**Связанные аспекты решения проблемы:**
...
Основная идея и концепция предлагаемого нами решения -  это обучить нейронную сеть для детекции тропических циклонов модель, обученную на открытых, либо созданных нами датасетах.
...
2. Нужно оценить качество данных, предоставленных в датасетах 
...
Мы активно **работаем** над улучшением нашей модели, одна их наших задач сегодня - это *ручная* разметка датасета для сегментации циклонов на [Roboflow](https://app.roboflow.com/).
